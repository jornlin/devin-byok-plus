  ...
  try {
    ...
    for (const _0x57381c of _0x454ebc) {
      if (_0x57381c.field === 3 && _0x57381c.wireType === 2) {
        ...
        console.log("  🔄 RegisterUser: " + _0x2976e7 + " → http://localhost:" + PORT);
        _0x46c307.push(writeStringField(3, "http://localhost:" + PORT));
...
server.on("connect", (_0xfd06cc, _0x5ae7ee, _0x53eefb) => {
...
server.listen(PORT, BIND_HOST, () => {
  console.log("\n⚡ Windsurf BYOK Bridge hybrid on http://localhost:" + PORT);
